...
AirThings device can be found using the `airthings_ble` ble scanner.
...
```
[16:13:19][D][airthings_ble:019]: Found AirThings device Serial: 123456789 (MAC: 01:02:03:04:05:06)
```
